# -*- coding: utf-8 -*-
"""Fingerprint.ipynb
This script processes CSV files containing SMILES strings and generates multiple
types of molecular fingerprints.

Designed for Google Colab. May require modification for local execution.
...
def process_file(filepath, output_dir="output"):
    ...
    # Save Results
    #In this step:
    # - Creates 5 separate CSV files per input file
    # - Each contains original columns + one fingerprint column
    # - Fingerprints are binary strings
